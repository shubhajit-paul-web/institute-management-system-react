...
const CardBtnGroup = ({courseId}) => {
	const navigate = useNavigate();

	return (
		<div className="text-sm font-medium flex gap-2 mt-3.5">
			<button onClick={() => navigate(`view/${courseId}`)} className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md dark:bg-[#58A6FF]/10 dark:text-[#58A6FF] dark:hover:bg-[#58A6FF]/20">
