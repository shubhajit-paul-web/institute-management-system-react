...
const ButtonOne = ({icon, text}) => {
	...
	return (
		<button onClick={handleModel} className={`flex items-center gap-2.5 px-4 py-2.5 rounded-lg text-lg font-medium bg-[#238636] text-white hover:bg-[#2ea043] shadow-md transition-colors duration-300`}>
