...
const InputField = ({label, type = "text", placeholder, register, name, errors = false, isTextArea, rows, options, optionsValues = [], className}) => {
	const lableID = useId();

	return (
		<div>
			<label className="text-white text-sm font-semibold" htmlFor={lableID}>
				{label}
			</label>
